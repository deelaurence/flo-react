...
import arrow from "./images/line 13.png"
    ...
    <section className='relative pb-40'>
        <div>
            <h1 className="text-4xl font-semibold md:text-5xl">
                 FLO'S <span className="block overflow-hidden">PORTFOLIO</span>
            </h1>

        </div>
        <div className='font-[300] text-[.9rem] leading-7 mt-14'>
            <p>Flourish Ralph focuses on using end-to-end
                <span className='block' > Product Design to create products that can</span>
                <span className='block'>offer users a seamless interaction experience</span>
                <span className='block'>with the aid of visual design, interaction</span>
                <span className='block'>design, and prototyping.</span>
                <br/>
